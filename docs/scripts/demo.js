  ...
  var Plot = (function () {
      ...
      Plot.prototype.reset = function () {
          ...
          if (canvas && !canvas.empty()) {
              ...
              this._svg.select("g.pending").style("display", null);
          }
          return this;
      };
      ...
      Plot.prototype.with = function (features) {
          if (features) {
              if (features.contours !== undefined) {
                  this.contours = features.contours;
              }
          }
          return this;
      };
