...
var Plot = (function () {
    function Plot(parentId, id) {
        ...
        this.shapes = [
            { path: pathCircle(3, 3, 2), name: "circle" },
            { path: pathTriangle([1, 5], [5, 5], [3, 1]), name: "triangle" },
            { path: pathSquare(3, 3, 4), name: "square" },
        ...
        this._svg = select("#" + this.id).classed("plot", true);
            ...
            if (selectOne) {
                ...
                this._svg.selectAll(".data-item")
                    ...
                    var result = this.id !== self.selected.id &&
                        ...
                        ? true
                        : false;
                    select(this).classed("fade", result);
                });
            }
        }
        return this;
