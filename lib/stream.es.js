...
var StreamGraph = (function () {
    function StreamGraph(parentid, id) {
        ...
        this._svg = select("#" + this.id).classed("stream", true);
        style.call(this._svg, ".data-item { transition: opacity 500ms ease-out }\n    .fade { fill-opacity: 0.05 }");
    }
    StreamGraph.prototype.data = function (data) {
        ...
        var mx = max(this._series, function (layer) { return max(layer, function (d) { return d[0] + d[1]; }); });
        var mi = min(this._series, function (layer) { return min(layer, function (d) { return d[0]; }); });
        this.domain.x = extent(this._dataMod, function (d) { return d.date; });
        this.domain.y = [mi, mx];
        this._area = area()
    ...
    StreamGraph.prototype.reset = function () { reset.call(this); return this; };
